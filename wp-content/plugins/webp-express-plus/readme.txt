...
Contributors: wp01ru
Tags: webp, images, performance, webp express, speed
...
#### Important ####
* The "WebP Express Plus" add-on only works when the ["WebP Express"](https://wordpress.org/plugins/webp-express/) plugin is active and properly configured.
...
#### Notes ####
* The performance was tested with different settings of "WebP Express". If you notice incorrect operation of "WebP Express Plus" - write to us at support@wp01.ru with an indication of all installed plugins and the problem that occurred.
